...
(function () {
  const DICT = {
    ko: {
      ...
      "set.lang": "언어 (Language)", "set.size": "앱 길이", "set.sizeNormal": "기본", "set.sizeCompact": "짧게", "set.data": "데이터", "set.reset": "모든 데이터 초기화",
    ...
    en: {
      ...
      "set.lang": "Language", "set.size": "App height", "set.sizeNormal": "Normal", "set.sizeCompact": "Compact", "set.data": "Data", "set.reset": "Reset all data",
    ...
    zh: {
      ...
      "set.lang": "语言", "set.size": "应用高度", "set.sizeNormal": "标准", "set.sizeCompact": "紧凑", "set.data": "数据", "set.reset": "重置所有数据",
    ...
    ja: {
      ...
      "set.lang": "言語", "set.size": "アプリの高さ", "set.sizeNormal": "標準", "set.sizeCompact": "コンパクト", "set.data": "データ", "set.reset": "すべてのデータを初期化",
