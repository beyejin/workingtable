...
(function () {
  const DICT = {
    ko: {
      ...
      "worktrack.externalOff": "WORKING — 클릭하면 외부/휴식 모드로 바뀌고 작업 시간이 멈춰요",
      "worktrack.externalOn": "EXTERNAL — 작업 시간 카운트가 멈춰 있어요. 클릭하면 다시 시작",
    ...
    en: {
      ...
      "worktrack.externalOff": "WORKING — click to switch to external/break mode and pause tracking",
      "worktrack.externalOn": "EXTERNAL — work time tracking is paused. Click to resume",
    ...
    zh: {
      ...
      "worktrack.externalOff": "WORKING — 点击切换到外部/休息模式并暂停计时",
      "worktrack.externalOn": "EXTERNAL — 工作时间计时已暂停。点击恢复",
    ...
    ja: {
      ...
      "worktrack.externalOff": "WORKING — クリックで外部/休憩モードに切り替え、作業時間を停止",
      "worktrack.externalOn": "EXTERNAL — 作業時間のカウントは停止中。クリックで再開",
