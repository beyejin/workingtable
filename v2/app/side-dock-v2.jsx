  ...
  return (
    <div style={{ height: "100%", overflowY: "auto", overflowX: "hidden", padding: "14px 16px" }}>
      ...
      <SetSection label={L("set.update")}>
        ...
        {updateStatus && <SetStatus>{updateStatus}</SetStatus>}
      </SetSection>
      ...
      <SetSection label={L("set.backup")}>
          ...
          <button
            onClick={async () => {
              try {
                ...
                const fileName = `todoary-backup-${stamp}.json`;
        ...
        {backupStatus && <SetStatus>{backupStatus}</SetStatus>}
      </SetSection>
